...
/**
 * Props for Dialog component - Atom level
 * 
 * A basic Dialog component for modal interactions following atomic design principles.
 * Built on shadcn/ui Dialog primitives with design token compliance and accessibility features.
 * 
 * @example
 * ```tsx
